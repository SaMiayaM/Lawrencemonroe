...
export const Section4ReleasedPieces: React.FC = () => {
  ...
  const product2 = RELEASED_PRODUCTS[1]; // LM Shorts 002 (Bone White)
  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8 md:px-12 relative z-10">
        ...
        {/* Asymmetrical Product 1 Block: LM Shorts 001 (Pitch Black) - Large Monumental Layout */}
        <div
          onMouseEnter={() => setHoveredProduct(product1.id)}
          onMouseLeave={() => setHoveredProduct(null)}
          className="relative grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center mb-24 sm:mb-36 group"
        >
          ...
          {/* Left Column: Monumental Tall Image Stage */}
          <div className="lg:col-span-7 relative z-10">
            ...
            >
              ...
              {/* Inset Secondary Detail View (Norell/Mondragon asymmetry) */}
              <div className="hidden sm:block absolute bottom-4 right-4 w-36 sm:w-44 h-48 sm:h-56 bg-black border border-line overflow-hidden shadow-2xl z-20 group-hover:translate-y-[-4px] transition-transform duration-500">
                <img
                  src="/images/campaign-contact-hardware.jpg"
                  alt="Hardware Detail"
                  className="w-full h-full object-cover grayscale contrast-125"
                />
                <div className="absolute bottom-1 left-1 right-1 font-mono text-[8px] text-smoke bg-black/80 px-1 py-0.5 text-center">
                  HARDWARE DETAIL
                </div>
              </div>
            </Link>
          ...
          <div className="lg:col-span-5 relative z-10 space-y-6 lg:pl-6">
            ...
            <div className="border-t border-b border-line/60 py-4 space-y-2 font-mono text-xs text-smoke">
              <div className="flex justify-between">
                <span>COLORWAY:</span>
                <span className="text-bone">PITCH BLACK / GOLD HARDWARE</span>
              </div>
              <div className="flex justify-between">
                <span>FABRIC:</span>
                <span className="text-bone">480GSM FRENCH TERRY</span>
              </div>
              <div className="flex justify-between">
                <span>SIZING:</span>
        ...
        {/* Asymmetrical Product 2 Block: LM Shorts 002 (Bone White) - Offset Inverse Layout */}
        <div
          onMouseEnter={() => setHoveredProduct(product2.id)}
          onMouseLeave={() => setHoveredProduct(null)}
          className="relative grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center group"
        >
          {/* Background Shifting Number */}
          ...
          <div className="order-2 lg:order-1 lg:col-span-5 relative z-10 space-y-6 lg:pr-6">
            ...
            <div className="border-t border-b border-line/60 py-4 space-y-2 font-mono text-xs text-smoke">
              <div className="flex justify-between">
                <span>COLORWAY:</span>
                <span className="text-bone">RAW BONE / GRAPHITE CORDS</span>
              </div>
              <div className="flex justify-between">
                <span>FABRIC:</span>
                <span className="text-bone">480GSM NATURAL TWILL</span>
              </div>
              <div className="flex justify-between">
                <span>SIZING:</span>
                <span className="text-bone">S • M • L • XL</span>
          ...
          {/* Right Column: Monumental Offset Image Stage */}
          <div className="order-1 lg:order-2 lg:col-span-7 relative z-10">
            <Link
              to={`/shop/${product2.slug}`}
              className="block relative bg-graphite border border-line overflow-hidden aspect-[4/5] sm:aspect-[16/11] lg:aspect-[4/5] group-hover:border-gold transition-colors duration-500"
            >
              ...
              <div className="absolute top-4 left-4 z-20">
                <div className="inline-flex items-center space-x-1.5 font-mono text-[9px] border border-gold bg-black/80 backdrop-blur-sm px-2.5 py-1 text-gold tracking-widest uppercase">
                  <span className="w-1.5 h-1.5 bg-gold" />
                  <span>EDITION 002 // BONE</span>
                </div>
              </div>

              {/* Inset Secondary Detail View */}
              <div className="hidden sm:block absolute bottom-4 left-4 w-36 sm:w-44 h-48 sm:h-56 bg-black border border-line overflow-hidden shadow-2xl z-20 group-hover:translate-y-[-4px] transition-transform duration-500">
                <img
