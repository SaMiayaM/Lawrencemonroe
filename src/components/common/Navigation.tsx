    ...
    <>
      <header
        className={`fixed top-0 left-0 w-full z-40 transition-all duration-500 ${
          isScrolled
            ? 'bg-black/90 backdrop-blur-md border-b border-line py-3.5 shadow-2xl'
      ...
      >
        <div className="max-w-7xl mx-auto px-5 sm:px-8 md:px-12 flex items-center justify-between">
          ...
          <div className="flex items-center space-x-3 sm:space-x-6">
            ...
            >
              <span>SHOP</span>
              <span className="text-gold text-[9px] font-mono">001</span>
            </Link>
        ...
        {isMobileMenuOpen && (
          ...
          >
            ...
            <div className="max-w-7xl w-full mx-auto px-5 sm:px-8 md:px-12 py-8 md:py-12 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center flex-1">
              ...
              {/* Right Column: Visual Campaign Collage / Preview (Desktop only) */}
